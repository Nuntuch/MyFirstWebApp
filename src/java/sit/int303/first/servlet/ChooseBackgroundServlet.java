...
public class ChooseBackgroundServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(bgColor != null && bgColor.trim().length()>0){
            ...
            response.sendRedirect("index.html");// ส่งไปหาบราวเซอร์แล้วให้บราวเซอร์ส่งกลับมาก่อนแล้วค่อยไปเรียก index.html
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ChooseBackgroundServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ChooseBackgroundServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
