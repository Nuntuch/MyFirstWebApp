...
import static sit.int303.first.servlet.RegisterServlet.cryptWithMD5;
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ActivateUserServlet</title>");
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ActivateUserServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
...
//        if(email != null && email.length()>0 && activateKey){}
    }
